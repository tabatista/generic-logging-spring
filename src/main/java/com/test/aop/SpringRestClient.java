...
public class SpringRestClient {
	...
	private void getEmployeeById() {
		...
		Funcionario result = restTemplate.getForObject(GET_EMPLOYEE_ENDPOINT_URL, Funcionario.class, params);
	...
	private void createEmployee() {
		...
		Funcionario newEmployee = new Funcionario("admin", "admin", "admin@gmail.com");

		RestTemplate restTemplate = new RestTemplate();
		Funcionario result = restTemplate.postForObject(CREATE_EMPLOYEE_ENDPOINT_URL, newEmployee, Funcionario.class);
	...
	private void updateEmployee() {
		Map<String, String> params = new HashMap<String, String>();
		params.put("id", "1");
		Funcionario updatedEmployee = new Funcionario("admin123", "admin123", "admin123@gmail.com");
		RestTemplate restTemplate = new RestTemplate();
